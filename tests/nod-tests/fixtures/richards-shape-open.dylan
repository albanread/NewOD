Module: richards-shape-open

define open class <task> (<object>) end class;

define open class <idler> (<task>)
  slot id-state :: <integer>, init-keyword: id-state:;
end class;

define open class <worker> (<task>)
  slot wk-state :: <integer>, init-keyword: wk-state:;
end class;

define open class <handler> (<task>)
  slot h-state :: <integer>, init-keyword: h-state:;
end class;

define open class <device> (<task>)
  slot d-state :: <integer>, init-keyword: d-state:;
end class;

define open generic run-task (t :: <task>, packet :: <integer>) => (<integer>);
