...
Per [MANIFESTO.md](../../../MANIFESTO.md), NewOpenDylan does **not** self-host. The upstream `dylan` library (96 files at `E:\opendylan\sources\dylan\`) is ported here as runnable Dylan source — not as compiler bootstrap. The Rust compiler reads these files at startup once the loader (Sprint 05) and codegen (Sprint 07) are online.
